...
const { db, normalizePhone, sendSMS, setCors } = require("./_lib");
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    await sendSMS(phone, `[JunkOut] Your password reset code is ${otp}. It expires in 5 minutes. Do not share this code with anyone.`);
